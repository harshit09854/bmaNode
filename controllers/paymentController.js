...
import CashfreeOrder from '../models/cashfreeOrderModel.js';
import Booking from '../models/bookingModel.js';
import NewYearBooking from '../models/newYearBookingModel.js';
import { v4 as uuidv4 } from 'uuid';
import { sendWhatsAppMessage, sendNewYearBookingConfirmationEmail } from '../utils/notification.js';
...
// @access  Private
export const adventureBookings = async (req, res) => {
    try {
        const {
...
// @access  Public
export const testCashfree = async (req, res) => {
    try {
...
// @access  Public
export const syncCashfreeOrder = async (req, res) => {
    try {
...
// @access  Public
export const createNewYearPayment = async (req, res) => {
...
// @access  Public
export const newYearBookingWebhook = async (req, res) => {
    try {
        const { data } = req.body;
...
// @access  Public
export const newYearBookingStatus = async (req, res) => {
    try {
        const booking = await NewYearBooking.findOne({
            $or: [
