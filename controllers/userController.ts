...
export const googleLogin = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const { name, email, picture, sub, azp, given_name } = payload;
...
// @access  Private
export const validateUser = (req: CustomRequest, res: Response) => {
    if (req.user) {
...
// @access  Private
export const customerLogout = (req: Request, res: Response) => {
...
// @access  Private
export const viewUserDetails = async (req: CustomRequest, res: Response) => {
    try {
...
// @access  Public
export const subscribeByUser = async (req: Request, res: Response) => {
    try {
